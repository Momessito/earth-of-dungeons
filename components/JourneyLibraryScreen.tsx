...
const JourneyLibraryScreen: React.FC = () => {
    ...
    if (selectedJourney) {
        return (
            <div className="bg-gray-900 bg-opacity-90 backdrop-blur-md p-6 sm:p-8 rounded-xl shadow-2xl w-full max-w-4xl mx-auto animate-fade-in">
    ...
    return (
        <div className="bg-gray-900 bg-opacity-80 backdrop-blur-sm p-6 sm:p-8 rounded-xl shadow-2xl w-full max-w-3xl mx-auto animate-fade-in">
            ...
            {journeys.length === 0 ? (
                ...
                <div className="space-y-3">
                    {journeys.map(journey => (
                        <div key={journey.id} className="bg-gray-800/50 p-4 rounded-lg flex flex-col sm:flex-row justify-between items-center gap-4">
                            <div>
